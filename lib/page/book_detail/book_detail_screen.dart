...
class _BookDetailState extends State<BookDetail>
  ...
  Widget build(BuildContext context) {
   // BookGreatest m=ModalRoute.of(context)!.settings.arguments as BookGreatest;
    return Scaffold(
      body: Column(
        children: [
          Stack(
                            ...
                            Align(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child:widget.m.favourite==1?Icon(Icons.favorite,color: Colors.red,): Icon(Icons.favorite_outline_sharp),
                                ),
                              ),
                            ),
                          ],
