...
//
// class BookGreatestDbController implements DbOperations<BookAll> {
//   final Database _database = DbController().database;
//
//   @override
//   Future<int> create(BookAll object) async {
//     // INSERT INTO contact (name, phone) VALUES ('Name','1234');
//     return await _database.insert('greatestBook', object.toMap());
//   }
//
//   @override
...
//     List<Map<String, dynamic>> rowsMap = await _database.query('greatestBook');
...
//         await _database.query('greatestBook', where: 'id = ?', whereArgs: [id]);
